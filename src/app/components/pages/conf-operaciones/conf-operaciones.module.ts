...
import { ConfOperacionesComponent } from './conf-operaciones.component';
...
const routes: Routes = [
  { path: '', component: ConfOperacionesComponent }
];

@NgModule({
  declarations: [ConfOperacionesComponent],
  imports: [
    CommonModule,
...
export class ConfOperacionesModule { }
