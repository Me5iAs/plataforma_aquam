...
import { PedidosRendirComponent, DialogUsuario } from './pedidos-rendir.component';
...
const routes: Routes = [
  { path: '', component: PedidosRendirComponent }
];

@NgModule({
  declarations: [PedidosRendirComponent, DialogUsuario],
  imports: [
    CommonModule,
...
export class PedidosRendirModule { }
